...
- конкретный patch-релиз CPython в конфигурации проекта;
- backend API adapter;
- frontend stack;
- основное хранилище;
...
ADR-0002 — выбор backend API adapter, на ревью.

## 9. Следующий планируемый блок

Финализация `ADR-0002`, затем `ADR-0003` — frontend stack.
...
- API adapter и остальной технологический стек не утверждены;
