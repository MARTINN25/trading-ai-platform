...
ADR-0005 — стратегия векторного поиска, на ревью.

## 9. Следующий планируемый блок

Финализация `ADR-0005`, затем `ADR-0006` — фоновые задачи и очередь.
