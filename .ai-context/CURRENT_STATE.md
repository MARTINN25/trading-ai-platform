...
ADR-0004 — выбор основного хранилища данных, на ревью.

## 9. Следующий планируемый блок

Финализация `ADR-0004`, затем `ADR-0005` — стратегия векторного поиска.
...
- основное хранилище и остальной технологический стек не утверждены;
