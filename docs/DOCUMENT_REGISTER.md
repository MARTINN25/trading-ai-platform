...
| `docs/decisions/ADR-0008-containerization-and-single-server-deployment.md` | ADR-0008 — Containerization and Single-Server Deployment | decisions | На ревью | Product Owner | определить стратегию контейнеризации и single-server deployment AI Trading Assistant Platform | 2026-08-05 | — | ожидает архитектурного ревью и принятия Product Owner |
