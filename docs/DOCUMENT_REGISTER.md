...
| `docs/decisions/ADR-0003-frontend-stack.md` | ADR-0003 — Frontend Stack | decisions | На ревью | Product Owner | Выбрать язык, UI-библиотеку и framework первого веб-клиента. | 2026-08-05 | — | Ожидает архитектурного ревью и принятия Product Owner. |
