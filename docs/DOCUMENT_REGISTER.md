...
| `docs/decisions/ADR-0009-observability.md` | ADR-0009 — Observability Strategy | decisions | На ревью | Product Owner | определить архитектурную стратегию observability AI Trading Assistant Platform | 2026-08-05 | — | ожидает архитектурного ревью и принятия Product Owner |
