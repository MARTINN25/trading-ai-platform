...
| `docs/product/PRODUCT_SCOPE.md` | Product Scope | product | Утверждён | Product Owner | Определить назначение, границы, пользователей и этапы развития продукта. | 2026-08-11 | — | Утверждённые границы и этапы продукта; раздел 30 дополнен статусом PO-2 (Phase 0). |
| `docs/product/FUNCTIONAL_REQUIREMENTS.md` | Functional Requirements | product | Утверждён | Product Owner | Определить функциональные требования AI Trading Assistant Platform. | 2026-08-11 | — | Утверждённые функциональные требования; FR-006/FR-032/FR-017 обновлены по итогам PO-3/PO-4/PO-6 (Phase 0). |
...
| `docs/product/USER_JOURNEYS.md` | User Journeys | product | Утверждён | Product Owner | Определить ключевые пользовательские сценарии платформы. | 2026-08-11 | — | Утверждённые пользовательские сценарии; UJ-005/UJ-019 обновлены по итогам PO-3/PO-4 (Phase 0). |
...
| `docs/architecture/MODULE_BOUNDARIES.md` | Module Boundaries | architecture | Утверждён | Product Owner | Определить логические границы модулей и разрешённые зависимости между ними. | 2026-08-11 | — | Утверждённые границы модулей и зависимостей; §12/§14 и DAG-матрица обновлены по итогам PO-4/PO-6 (Phase 0). |
| `docs/architecture/DATA_FLOWS.md` | Data Flows | architecture | Утверждён | Product Owner | Определить основные логические потоки данных платформы. | 2026-08-11 | — | Утверждённые логические потоки данных; DF-001/DF-011 обновлены по итогам PO-4/PO-6 (Phase 0). |
...
| `docs/architecture/TECHNOLOGY_EVALUATION.md` | Technology Evaluation | architecture | Утверждён | Product Owner | Сравнить технологические варианты для MVP и подготовить основания для отдельных ADR выбора стека. | 2026-08-11 | — | Утверждённое сравнительное основание для отдельных ADR; раздел 14 (многорыночные провайдеры) и дорожная карта (11 ADR) добавлены по итогам PO-2 (Phase 0); не является действующим решением о технологическом стеке. |
| `docs/architecture/INFORMATION_ARCHITECTURE.md` | Information Architecture | architecture | На ревью | Product Owner | Детализировать FR-003/FR-004 и `PRODUCT_SCOPE.md` §10 — как связаны утверждённые продуктовые области. | 2026-08-11 | — | Новый документ Phase 0 (PO-1); информационная архитектура, не визуальный дизайн. |
| `docs/architecture/TARGET_INTELLIGENCE_CONTEXT.md` | Target Intelligence Context | architecture | На ревью | Product Owner | Определить концептуальный пакет контекста, собираемый перед AI-синтезом, и стадийность его категорий. | 2026-08-11 | — | Новый документ Phase 0 (PO-6); классификация, не разрешение реализации; AI — один компонент конвейера. |
